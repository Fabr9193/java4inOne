...
public class RssAggregatorLogin extends javax.swing.JFrame {
    ...
    public RssAggregatorLogin(RssAggregatorSession sess){
        this.sess = sess;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Rss Feed Aggregator");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.sess.setMail(this.jTextField1.getText());
        this.sess.setPassword(this.jPasswordField1.getText());
        int r = this.sess.Login();
        if (r == 200)
        {
            this.jLabel5.setText("Connected");
            this.setVisible(false);
            try {
                new RssAggregatorGUI(sess).setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            this.jLabel5.setText("Registering...");
            this.sess.setMail(this.jTextField1.getText());
            this.sess.setPassword(this.jPasswordField1.getText());

            int r = this.sess.Register();
            if (r == 200)
            {
                this.jLabel5.setText("Connected");
                this.dispose();
